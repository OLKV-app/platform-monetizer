...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "OLKV — Lakshadweep Marketplace" },
      { property: "og:description", content: "OLKV is Lakshadweep's marketplace to buy, sell, and connect. Boats, fishing gear, mobiles, vehicles, property, jobs and more across every island." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "OLKV" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "OLKV — Lakshadweep Marketplace" },
      { name: "twitter:description", content: "OLKV is Lakshadweep's marketplace to buy, sell, and connect. Boats, fishing gear, mobiles, vehicles, property, jobs and more across every island." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/oqUTMPNUCkTJlPooAcXBgoLsg6O2/social-images/social-1784799073413-favicon.ico.webp" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/oqUTMPNUCkTJlPooAcXBgoLsg6O2/social-images/social-1784799073413-favicon.ico.webp" },
    ],
    links: [
