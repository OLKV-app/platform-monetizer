          ...
          >
            ...
            <div className="min-w-0 flex-1">
              <div className="font-semibold">
                ...
                <span className="ml-1 rounded-full bg-muted px-2 py-0.5 text-[10px] uppercase text-muted-foreground">
                  {b.banner_type ?? "home"}
                </span>
              </div>
              ...
              <div className="text-[10px] text-muted-foreground">
                Runs {fmt(b.starts_at)} → {fmt(b.ends_at)} •{" "}
                {b.view_count ?? 0} views •{" "}
                {b.click_count ?? 0} clicks
              </div>
            </div>
